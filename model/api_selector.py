...
class APISelector(Runnable):
    ...
    def _call(self, inputs: Dict[str, Any]) -> Dict[str, str]:
        ...
        api_plan = re.sub(r"API calling \d+: ", "", api_selector_chain_output.content).strip()
        ...
        if isinstance(api_plan, dict):  # ✅ Ensure we extract "result" if api_plan is a dict
            api_plan = api_plan.get("result", "")
