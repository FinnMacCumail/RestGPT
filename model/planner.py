...
class Planner(Runnable):
    ...
    def _construct_scratchpad(
        ...
        for i, (plan, execution_res) in enumerate(history):
            ...
            scratchpad += self.llm_prefix.format(i + 1) + plan["result"] + "\n"
    ...
    def _call(self, inputs: Dict[str, str]) -> Dict[str, str]:
        ...
        planner_chain_output = re.sub(r"Plan step \d+: ", "", planner_chain_output.content).strip()

        return {"result": planner_chain_output}
    
        # ✅ Add this method to satisfy Runnable requirements
